<%-- 
    Document   : Categoria_Niños
    Created on : 2/02/2022, 11:36:19 a. m.
...
<!DOCTYPE html>
<%
    ArrayList<productos> produto = (ArrayList) request.getAttribute("niños");
%>
<html>
    <head>
    ...
    <body>
        ...
        <h1 id="titulo-ultimos-productos">productos niños</h1>
        <section class="py-5">
