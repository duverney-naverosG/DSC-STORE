<%-- 
    Document   : Categoria_Mujeres
    Created on : 2/02/2022, 11:35:59 a. m.
...
<!DOCTYPE html>
<%
    ArrayList<productos> produto = (ArrayList) request.getAttribute("mujer");
%>
<html>
    <head>
    ...
    <body>
        ...
        <h1 id="titulo-ultimos-productos">productos damas</h1>
        <section class="py-5">
